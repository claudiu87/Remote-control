...
function chart(dataPoints) {
  ...
  resetChartZoom = function resetZoom() {
    myChart.resetZoom();
  }
...
function index() {
  ...
  switch (event.srcElement.id) {
    ...
    case "gpioPin12":
      dataFromServer.gpioPin12 ^= true;
      break;
    case "gpioPin11":
      dataFromServer.gpioPin11 ^= true;
      break;
    case "gpioPin10":
      dataFromServer.gpioPin10 ^= true;
      break;
    case "gpioPin09":
      dataFromServer.gpioPin09 ^= true;
      break;
    case "BLDCslider":
      dataFromServer.motorSpeed = $(".slider").val();
      break;
    case "stopMotor":
      dataFromServer.motorSpeed = 1000;
      break;
    default:
      dataFromServer.ERR = true;
  }
